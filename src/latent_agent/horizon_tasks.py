...
SENSOR_STAGES = {
    ...
    "xlong": (
        ...
        "Aggregate by site and write sensor_xlong_site_summary.csv with site, temp_std, alert_rate = sum(alert) / reading_count for that site, reading_count sorted by site; do not divide temp_std by reading_count.",
    ...
    "xxlong": (
        ...
        "Compute alert = (adjusted_temp > 76) | (adjusted_pressure > 105).",
        "Aggregate site-hour alerts as an intermediate check.",
        "Aggregate by site and write sensor_xxlong_site_summary.csv with site, temp_std, alert_rate = sum(alert) / reading_count for that site, reading_count sorted by site; do not divide temp_std by reading_count.",
